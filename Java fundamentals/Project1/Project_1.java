...
public class Project1 
{
    ...
    public int getSalary(int id) 
    {
        ...
        if(index == -1) 
            return -1;
        return (basic[index] + hra[index] - it[index] + calDA(index));
    }
	...
	public static void main(String[] args) 
    {
		...
		if(args.length != 1) 
			System.out.println("Provide the java Employee emp_id");
		else 
        {
			...
			if(emp.empExists(emp_id)) 
            {
				...
				System.out.printf("%8s    ", emp.getDept(emp_id));
